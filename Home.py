...
st.caption(
    "Machine learning-powered credit risk assessment and loan decision support"
)
...
st.markdown(
    '<div class="section-title">Approval rate by loan purpose</div>',
    unsafe_allow_html=True
)

st.caption(
    "How likely an application is to be approved, based on why the applicant is borrowing"
)
...
st.markdown(
    '<div class="section-title">Explore the app</div>',
    unsafe_allow_html=True
)
